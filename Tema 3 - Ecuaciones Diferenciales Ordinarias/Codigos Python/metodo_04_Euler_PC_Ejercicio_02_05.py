...
ejex = np.loadtxt('valores_CD_05.txt')[:, 1]
...
plt.plot(ejex[:432], col_CD0[:432], label="Sin fricción")
plt.plot(ejex[:432], col_CD5[:432], label="Cd = 0.5")
plt.plot(ejex[:431], col_CD75[:431], label="Cd = 0.75")
plt.xlabel('x')
plt.ylabel('y')
plt.xlim([0, 90])
