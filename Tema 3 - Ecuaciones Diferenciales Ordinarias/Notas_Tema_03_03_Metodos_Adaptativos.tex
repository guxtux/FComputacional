...
Aquí es donde los \textbf{\textocolor{carmine}{métodos adaptativos}} llegan para apoyarnos: \pause estiman el error de truncamiento en cada paso de integración y ajustan automáticamente el tamaño de paso para mantener el error dentro de los límites prescritos.
\end{frame}
\begin{frame}
\frametitle{Fórmulas de integración}
Los métodos de Runge-Kutta adaptativos utilizan las denominadas \textbf{\textocolor{blue}{fórmulas de integración incorporadas}}.
\\
\medskip
\pause
...
\textbf{\textocolor{red}{¿Hay alguna razón para usar los métodos no adaptativos?}}
\\
\bigskip
\pause
...
\bigskip
\pause
\textbf{\textocolor{burgundy}{Calcula su altura y velocidad}} luego de $10$ segundos de caída, utiliza el método RK adaptativo.
\end{frame}
\begin{frame}
