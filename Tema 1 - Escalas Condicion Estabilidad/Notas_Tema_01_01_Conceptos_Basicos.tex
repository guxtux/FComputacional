...
Los cálculos efectuados en el segundo ejercicios son \textoazul{inestables}, \pause ya que los errores producidos en una iteración, se incrementan en iteraciones posteriores.
\end{frame}
