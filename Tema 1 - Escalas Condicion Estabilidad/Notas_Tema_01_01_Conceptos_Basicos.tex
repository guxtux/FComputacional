...
\frame[allowframebreaks]{\frametitle{Contenido} \tableofcontents[currentsection, hideothersubsections]}
\subsection{Computadoras y números}
...
\pause
\begin{center}
    \textoazul{¿Que tan pequeña debe de ser una diferencia mínima?}
\end{center}
\end{frame}
\begin{frame}
...
Los dos ejemplos que presentamos, los cálculos efectuados son \textoazul{inestables}, \pause por que los errores producidos en una iteración, se incrementan en iteraciones posteriores.
\end{frame}
