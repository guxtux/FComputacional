...
\begin{figure}
    \centering
    \includegraphics[scale=0.55]{Imagenes/Encuentra_Raices_01.eps}
\end{figure}
\end{frame}
...
\begin{center}
    ...
    \end{tikzpicture}
\end{center}
La separación entre los puntos es una constante $h = \dfrac{b - a}{n}$, donde $n$ es el número de puntos.
\end{frame}
