...
\\
\bigskip
Los valores de $x$ que hacen que $y = 0$ se denominan \textocolor{blue}{raíces de la ecuación}.
\end{frame}
\begin{frame}
\frametitle{Cálculo de raíces}
...
\begin{frame}
\frametitle{Método de incrementos sucesivos}
El método de \textocolor{blue-violet}{búsqueda incremental} es una herramienta útil que podemos adoptar en conjunto con otras estrategias de cálculo de raíces.
\\
\bigskip
\
...
\begin{frame}
\frametitle{Método de Bisección}
El \textocolor{cadmiumgreen}{método de bisección} logra esta tarea: \pause \textocolor{red}{el intervalo se reduce sucesivamente a la mitad  hasta que se vuelve suficientemente pequeño}. 
\end{frame}
\begin{frame}
\frametitle{Método de Bisección}
